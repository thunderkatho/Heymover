...
const tiers = [
  {
    ...
    color: "#FF6B6B",
    colorLight: "#FFF0F0",
    desc: "You're new here. We'll make sure you don't get ripped off finding a mover.",
    features: [
      "3 curated mover quotes from vetted companies",
      "Side-by-side price & review comparison",
      "Booking intro — we connect you directly",
      "First-time NYC mover checklist",
      "Email support through move day",
    ],
  },
  {
    id: "standard",
    ...
    price: "$149",
    emoji: "🏙️",
    tagline: "We handle the NYC stuff nobody tells you about.",
    color: "#6C63FF",
    colorLight: "#F0EFFE",
    desc: "COIs, elevator reservations, management offices — the NYC gotchas that blindside first-timers.",
    features: [
      ...
      "Parking permit research for your block",
  ...
  },
  {
    ...
    features: [
      ...
      "Day-of oversight via phone/text",
