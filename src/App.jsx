...
const tiers = [
  {
    ...
    features: [
      "3 curated quotes from vetted NYC movers",
      "Personalized mover matching based on your building and move details",
      "Side-by-side comparison of pricing, reviews, and mover strengths",
      "Hidden fee and red-flag review screening",
      "Direct booking introduction to your best-fit mover",
      "NYC move prep checklist and timeline",
